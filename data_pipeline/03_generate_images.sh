...
# Define paths
INPUT_DIR="/gpfs/scratch/ehpc42/datasets/datacomp/large_hybrid/prompts"
OUTPUT_DIR="/gpfs/scratch/ehpc42/datasets/datacomp/large_hybrid/edits"
mkdir -p "$OUTPUT_DIR"
...
srun python /gpfs/projects/ehpc42/code/04_generate_images_multigpu.py \
     --input_files "${subset[@]}" \
