...
#SBATCH --job-name=open_clip_large_hybrid
#SBATCH --account=ehpc42         
#SBATCH --qos=acc_ehpc          
#SBATCH --partition=acc        
#SBATCH --time=14:00:00         # Adjust the wallclock time according to the scale 
...
# Paths and settings
DATA_PATH="/gpfs/scratch/ehpc42/datasets/datacomp/large_hybrid/shards/"
SCALE="large"
SEED=0
OUTPUT_DIR="/gpfs/projects/ehpc42/jobs_output"
NUM_CHECKPOINTS=8
EXP_NAME="datacomp-scale-${SCALE}-hybrid-seed${SEED}"
